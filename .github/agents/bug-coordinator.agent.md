...
tools: ['search/codebase', 'search/fileSearch', 'search/textSearch', 'read/readFile', 'edit/editFiles', 'edit/createFile', 'edit/createDirectory','web/fetch','atlassian-mcp-atlassian/*']
infer: true
