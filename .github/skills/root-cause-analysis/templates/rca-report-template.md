...
const finalAmount = transaction.amount * (1 + TAX_RATE); // ← Fault: transaction is undefined
...
- **Unit tests**: 
  ...
  - Test normal flow for amounts ≤ $1000
- **Integration tests**:
...
|----------|------------|------|--------|-----------------|-------------|
| Primary (Throw Error) | Low | Low | 2h | Clear error message | ✅ Yes |
| Alt 1 (Result Type) | Medium | Low | 4h | Clear error message | If Result pattern exists |
| Alt 2 (Type Guard) | Low | Medium | 1h | Generic 500 error | ❌ No |
